...
export const alt = "Ask4Loan blog article";
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const title = post?.meta.title ?? "Ask4Loan Blog";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <span style={{ fontSize: 24, color: "rgba(255,255,255,0.55)" }}>ask4loan.ca/blog</span>
      </div>
    ),
    { ...size },
  );
